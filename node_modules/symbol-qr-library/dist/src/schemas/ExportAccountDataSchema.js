...
var ExportAccountDataSchema = /** @class */ (function (_super) {
    ...
    ExportAccountDataSchema.prototype.getData = function (qr) {
        ...
        var encrypted = index_1.EncryptionService.encrypt(qr.account.privateKey, qr.password);
        return {
    ...
    ExportAccountDataSchema.parse = function (json, password) {
        ...
        try {
            ...
            var payload = index_1.EncryptedPayload.fromJSON(JSON.stringify(jsonObj.data));
            // decrypt private key
            var privKey = index_1.EncryptionService.decrypt(payload, password);
            ...
            // create account
            var account = symbol_sdk_1.Account.createFromPrivateKey(privKey, network);
            return new index_1.AccountQR(account, password, network, generationHash);
        }
        catch (e) {
