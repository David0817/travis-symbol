...
var AddContactDataSchema = /** @class */ (function (_super) {
    ...
    AddContactDataSchema.parse = function (json) {
        ...
        var account = symbol_sdk_1.PublicAccount.createFromPublicKey(jsonObj.data.publicKey, network);
        var generationHash = jsonObj.chain_id;
        return new index_1.ContactQR(name, account, network, generationHash);
    };
