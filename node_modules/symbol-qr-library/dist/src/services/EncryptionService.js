...
var EncryptionService = /** @class */ (function () {
     ...
     * @param json
     */
    EncryptionService.decrypt = function (payloadOrJson, password) {
        var payload;
        // parse input if necessary
        if (payloadOrJson instanceof index_1.EncryptedPayload) {
            payload = payloadOrJson;
        }
        else {
            payload = index_1.EncryptedPayload.fromJSON(payloadOrJson);
        }
        // read payload
