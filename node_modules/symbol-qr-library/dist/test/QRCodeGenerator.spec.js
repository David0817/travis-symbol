...
describe('QRCodeGenerator -->', function () {
    describe('createExportObject() should', function () {
        it('use default values for network_id and chain_id', function () {
            ...
            var object = {};
            // Act:
            var objectQR = index_1.QRCodeGenerator.createExportObject(object);
            // Assert:
    ...
    describe('createTransactionRequest() should', function () {
        it('generate correct Base64 representation for TransferTransaction', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestTx = index_1.QRCodeGenerator.createTransactionRequest(transfer);
    ...
    describe('createAddContact() should', function () {
        it('generate correct Base64 representation for AddContact', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        createContact = index_1.QRCodeGenerator.createAddContact(name, account);
    ...
    describe('createExportAccount() should', function () {
        it('generate correct Base64 representation for ExportAccount', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        exportAccount = index_1.QRCodeGenerator.createExportAccount(account, 'password');
    ...
    describe('createExportMnemonic() should', function () {
        it('generate correct Base64 representation for ExportMnemonic', function () { return __awaiter(_this, void 0, void 0, function () {
            var mnemonic, exportMnemonic, actualBase64;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mnemonic = symbol_hd_wallets_1.MnemonicPassPhrase.createRandom();
                        exportMnemonic = index_1.QRCodeGenerator.createExportMnemonic(mnemonic, 'password');
    ...
    describe('fromJSON() should', function () {
        it('Populate transaction data given TransactionQR JSON', function () {
            ...
            var requestTx = index_1.QRCodeGenerator.createTransactionRequest(transfer, symbol_sdk_1.NetworkType.MIJIN_TEST);
            var txJSON = requestTx.toJSON();
            // Act:
            var transactionObj = index_1.QRCodeGenerator.fromJSON(txJSON);
            // Assert:
            ...
            chai_1.expect(transactionObj.transaction.toJSON()).to.deep.equal(transfer.toJSON());
        ...
        it('Populate contact information given ContactQR JSON', function () {
            ...
            var createContact = index_1.QRCodeGenerator.createAddContact(name, account, symbol_sdk_1.NetworkType.MIJIN_TEST);
            var contactJSON = createContact.toJSON();
            // Act:
            var contactObj = index_1.QRCodeGenerator.fromJSON(contactJSON);
            // Assert:
            chai_1.expect(contactObj.toJSON()).to.not.be.equal('');
            chai_1.expect(contactObj.type).to.be.equal(index_1.QRCodeType.AddContact);
            chai_1.expect(contactObj.account.address).to.deep.equal(account.address);
        ...
        it('Populate account information given AccountQR JSON', function () {
            ...
            var exportAccount = index_1.QRCodeGenerator.createExportAccount(account, 'password');
            var actualObj = exportAccount.toJSON();
            // Act:
            var accountObj = index_1.QRCodeGenerator.fromJSON(actualObj, 'password');
            // Assert:
            ...
            chai_1.expect(accountObj.account).to.deep.equal(account);
            chai_1.expect(accountObj.account.privateKey).to.be.equal('F97AE23C2A28ECEDE6F8D6C447C0A10B55C92DDE9316CCD36C3177B073906978');
        });
        it('Populate object given ObjectQR JSON', function () {
            ...
            var exportObject = index_1.QRCodeGenerator.createExportObject(object);
            var actualObj = exportObject.toJSON();
            // Act:
            var objectObj = index_1.QRCodeGenerator.fromJSON(actualObj);
            // Assert:
        ...
        it('Populate mnemonic pass phrase given MnemonicQR JSON', function () {
            ...
            var exportMnemonic = index_1.QRCodeGenerator.createExportMnemonic(mnemonic, 'password');
            var actualObj = exportMnemonic.toJSON();
            // Act:
            var mnemonicObj = index_1.QRCodeGenerator.fromJSON(actualObj, 'password');
            // Assert:
            ...
            chai_1.expect(mnemonicObj.mnemonic).to.deep.equal(mnemonic);
            chai_1.expect(mnemonicObj.mnemonic.plain).to.be.equal(mnemonic.plain);
        });
    });
});
